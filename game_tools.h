 ...
 * @details The game @p g is updated with the first solution found.
 * If there are no solution for this game, @p g must be unchanged.
 ...
 * @param g the game
 * @details The game @p must be unchanged.
